...
return (
  ...
  <div className="flex justify-between items-start">
    ...
    <span className="bage bage-secondary"> {book.publishYear}</span>
  </div>
  ...
  {/*Author*/}
  <div className="flex items items-centre gap-2 text-base-content/70">
  ...
  <div className="flex items-centre gap-4">
    ...
    <div className="tooltip tooltip-warning" data-tip="Edit book">
      <Edit2 className="size-4 text-warning hover:scale-110 transtion" />
    </div>
  ...
  {showModal && (<dialog className="modal modal-open">
    ...
    <h3 className="font-bold text-lg text-error flex items-centre gap-2">
    ...
    <span className="font-semibold text-base-content">
      ...
      <div className="modal-action">
        ...
        <button className="btn btn-error flex items-centre gap-2"
